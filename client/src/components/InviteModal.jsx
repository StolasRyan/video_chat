...
const InviteModal = ({channel, onClose}) => {
    ...
    const handleInvite = async()=>{
        ...
        try {
            ...
            setError('Error inviting users', error);
    ...
    <div className="create-channel-modal-overlay">
        <div className="create-channel-modal">
            ...
            <div className="create-channel-modal-header">
                ...
                <button
                onClick={onClose}
                className="create-channel-modal__close"
                >
            ...
            {users.length > 0 && (
                users.map((user) => {
                    ...
                    return(
                        <label
                        key={user.id}
                        className={`flex items-center gap-4 p-3 rounded-lg cursor-pointer transition-all shadow-sm bg-white hover:bg-[#f3f5ff] border-2
                            ...
                            <input
                                ...
                                onChange={(e)=>{
                                    if(e.target.checked){
                                        ...
                                        setSelectedMembers(selectedMembers.filter((u)=> u!==user.id))
                                    }
                                }}
                            />
                            {user?.image ? (
             ...
             <div className='create-channel-modal__actions mt-4'>
                ...
                disabled={isInviting || !selectedMembers.length}
                >
