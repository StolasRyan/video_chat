...
const UsersList = ({activeChannel}) => {
    ...
    if(isError) return <div className="team-channel-list__message">Failed loading users</div>
    if(users.length === 0) return <div className="team-channel-list__message">No users found</div>
  return (
          ...
          >
            <div className="flex items-center gap-2 w-full">
              <div className="relative">
                  ...
                  />)
                  :(<div
                    className="size-4 rounded-full bg-gray-400 flex items-center justify-center">
