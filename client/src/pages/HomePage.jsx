...
const HomePage = () => {
  ...
  if (error)
    return (
      <p className="bg-red-100 rounded p-2 text-red-600 border border-red-300">
            ...
            {/* HEADER */}
              <div className="team-channel-list__header gap-4">
                <div className="brand-container">
                  <img src="/logo.png" alt="Puga" className="brand-logo"/>
                ...
                <ChannelList
                  ...
                  Preview={({channel})=>(
                    ...
                    channel={channel}
                      ...
                      setActiveChannel={(channel)=>setSearchParams({chanel: channel.id})}
                    />
                  )}
